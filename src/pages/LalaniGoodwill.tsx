        ...
        <section className="py-16 md:py-20 bg-card">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            <motion.div
              ...
              className="text-center mb-12"
            >
              <p className="text-primary text-sm font-semibold tracking-widest uppercase mb-2">Location</p>
              <h2 className="text-3xl md:text-4xl lg:text-5xl font-heading font-bold text-foreground mb-3">
                Visit Our Office
              </h2>
            ...
            <div className="grid md:grid-cols-2 gap-6 md:gap-8">
                ...
                <div className="bg-background p-6 rounded-2xl border border-border">
                  ...
                  <div className="space-y-4 text-muted-foreground">
                    <p className="flex items-start gap-3">
                      ...
                      <span>7th Floor, Lalani Aura, 34th Road,<br />Khar (W), Mumbai - 400052</span>
                    </p>
                    <p className="flex items-center gap-3">
                      <span className="text-primary">📞</span>
                      <span>022-6728 0000</span>
                    </p>
                    <p className="flex items-center gap-3">
                      <span className="text-primary">📱</span>
                    ...
                    <p className="flex items-center gap-3">
                      ...
                      <span>info@lalanigroup.in</span>
                    </p>
                  </div>
                  <a
                    href="https://www.google.com/maps?q=LALANI+GROUP,+3R7P+QMJ,+34th+Rd,+Khar+West,+Mumbai,+Maharashtra+400052"
                    target="_blank"
                    rel="noopener noreferrer"
              ...
              <motion.div
                ...
                whileInView={{ opacity: 1, x: 0 }}
                viewport={{ once: true }}
                className="rounded-2xl overflow-hidden h-[250px] sm:h-[300px] md:h-full min-h-[250px] border border-border"
              >
                <iframe
