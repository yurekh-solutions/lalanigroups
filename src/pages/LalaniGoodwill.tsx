...
const LalaniGoodwill = () => {
  ...
  <section className="relative min-h-[80vh] md:min-h-screen overflow-hidden flex items-center justify-center"> <div className="absolute inset-0"> <img src={mainElevation} alt="Lalani Goodwill" className="w-full h-full object-cover" /> </div> </section> 
