...
,
  ...
  // LALANI AURA (Completed)
  {
    ...
    description: "Lalani Aura on 34th Road, Khar (W) is the prestigious headquarters of Lalani Group itself. A landmark mixed-use development combining premium office and commercial spaces, Lalani Aura represents the pinnacle of the Group's architectural excellence in one of Mumbai's most prime neighborhoods.",
    highlights: ["Lalani Group Headquarters", "Prime 34th Road, Khar (W) address", "Mixed-use development", "Premium commercial spaces", "Iconic architectural design"],
